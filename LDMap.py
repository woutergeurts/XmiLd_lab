...
class PropertyMap:
    def __init__(self, modelPrefix):
        ...
        tmpdict['times/modified']     = ['xmi:modified',     'Literal', XSD.string   ]
        tmpdict['times/lastloaddate'] = ['xmi:lastloaddate', 'Literal', XSD.string   ]
        tmpdict['times/lastsavedate'] = ['xmi:lastsavedate', 'Literal', XSD.string   ]
        ...
        tmpdict['flags/iscontrolled'] = ['xmi:iscontrolled', 'Literal', XSD.string ]
        tmpdict['flags/isprotected']  = ['xmi:isprotected',  'Literal', XSD.string ]
        ...
        tmpdict['properties/isSpecification'] = ['xmi:isSpecification', 'Literal', XSD.string ]
        ...
        tmpdict['properties/isRoot']  = ['xmi:isRoot',       'Literal', XSD.string ]
        tmpdict['properties/isLeaf']  = ['xmi:isLeaf',       'Literal', XSD.string ]
        tmpdict['properties/isAbstract'] = ['xmi:isAbstract','Literal', XSD.string ]
        tmpdict['properties/isActive'] = ['xmi:isActive',    'Literal', XSD.string ]
        ...
        tmpdict['project/created']    = ['xmi:created',      'Literal', XSD.string ]
        tmpdict['project/modified']   = ['xmi:modified',     'Literal', XSD.string ]
